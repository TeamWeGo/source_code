      ...
      <div class="modalContent">
        ...
        <div class="question" v-if="type=='单选'">
          ...
          <div class="selectionList" v-for="(item, index) in selections" :key="index" >
            ...
            <input class="selection" v-model="selections[index]" placeholder="请输入选项">
            <img class="icon"  mode="widthFix" src="/static/images/question/delete.png" @click="deleteselection(index)">
          </div>
          <img class="icon"  mode="widthFix" src="/static/images/question/add.png" @click="addselection">
        </div>
